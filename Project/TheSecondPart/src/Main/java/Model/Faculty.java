...
public class Faculty {
    ...
    public Faculty(String name, String facultyCode, int budgetNumberPositions, int tollNumberPositions,
                   int countrySideNumberPositions, int minorityNumberPositions) {
        this.name = name;
