...
public class CandidateApplication implements Comparable<CandidateApplication> {
    ...
    public CandidateApplication(String codeSpec, String facultyCode, Candidate candidate, String admissionOption) {
        this.codeSpec = codeSpec;
        this.facultyCode = facultyCode;
        this.candidate = candidate;
        this.admissionOption = admissionOption;
    }
    public CandidateApplication(String applicationCode, String codeSpec, String facultyCode, Candidate candidate, String admissionOption, double admissionExam) {
