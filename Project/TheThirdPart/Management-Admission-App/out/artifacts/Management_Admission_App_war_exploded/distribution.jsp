...
<div class="topnav">
    <ul>
        ...
        <li><a class="list" href="all_applications.jsp">ALL APPLICATIONS</a></li>
        <li><a class="list" href="distribution.jsp">ADMISSION RESULTS</a></li>
...
<body>
    ...
    <h1 style="text-align: center">Admitted candidate to the budget for all specializations</h1>
    <form>
        <div class="continut">
    ...
    <%
        ...
        if(code_f != null)
        {
            for(Specialization s: S){
                ...
                L = distributionService.getAdmittedCandidatesSpecB(code_f, code);
