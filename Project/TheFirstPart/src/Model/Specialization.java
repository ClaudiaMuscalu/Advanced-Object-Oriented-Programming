...
public class Specialization
{
    ...
    public Specialization(String code, String nameS, int numberOfPositionsBudget,
                          int numberOfPositionsToll, int countrySideNumberPositions,
                          int minority, String facultyCode)
    {
